...
let rec is_ground_term vars = function
  ...
  | Less (expr1,expr2) | LessEq (expr1,expr2) | Great (expr1,expr2) | GreatEq (expr1,expr2)
  | Pair (expr1,expr2) -> (is_ground_term vars expr1) && (is_ground_term vars expr2)
  | Not expr -> is_ground_term vars expr 
  | If (expr1,expr2,expr3) -> (is_ground_term vars expr1) && (is_ground_term vars expr2) && (is_ground_term vars expr3)
  | _ -> false
...
let is_ground_term_with_hole vars expr = 
  ...
  (* First boolean indicate if the term contain a Hole, the second boolean indicate if the term is ground *)
   ...
   | Equal (expr1,expr2) | NEqual (expr1,expr2)
   | Less (expr1,expr2) | LessEq (expr1,expr2) | Great (expr1,expr2) | GreatEq (expr1,expr2)
   | Pair (expr1,expr2) -> bin_bool_or (aux expr1) (aux expr2)
   | Not expr -> aux expr 
   | If (expr1,expr2,expr3) -> bin_bool_or (aux expr1) (bin_bool_or (aux expr2) (aux expr3))
   | _ -> (false,false)
...
let rec unif flag vars support gsubst1 gsubst2 (expr1,expr2) = match (expr1,expr2) with
...
(*  | (Var x,expr) ->  if (is_ground_term vars expr) then Some (gsubst1,(x,expr)::gsubst2,expr1) else (print_endline ("Failed1: " ^ (string_of_exprML expr)); None) *)
  ...
  | (Bool b1, Bool b2) -> if (b1 = b2) then Some (support,gsubst1,gsubst2,expr2) else None 
  | (Plus (e11,e12),Plus (e21,e22)) | (Minus (e11,e12),Minus (e21,e22))  | (Mult (e11,e12),Mult (e21,e22)) | (Div (e11,e12),Div (e21,e22)) 
  | (And (e11,e12),And (e21,e22)) | (Or (e11,e12),Or (e21,e22)) | (Equal (e11,e12),Equal (e21,e22)) | (NEqual (e11,e12),NEqual (e21,e22)) 
  | (Less (e11,e12),Less (e21,e22)) | (LessEq (e11,e12),LessEq (e21,e22)) | (Great (e11,e12),Great (e21,e22)) | (GreatEq (e11,e12),GreatEq (e21,e22)) 
  | (App (e11,e12),App (e21,e22)) | (Seq (e11,e12),Seq (e21,e22)) | (Pair (e11,e12),Pair (e21,e22)) 
  | (Assign (e11,e12),Assign (e21,e22)) | (Let (_,e11,e12),Let (_,e21,e22)) ->
...
let unif_in_hist sequent hist = 
  ...
  | (sequent',flag)::tl -> begin match unif_sequent flag sequent sequent' with 
                        | None -> aux tl
                        | Some (gsubst1,gsubst2,sequent'') -> Some (gsubst1,gsubst2,sequent',sequent'')
                    end
  in aux hist'
